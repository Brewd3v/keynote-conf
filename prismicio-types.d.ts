...
type PageDocumentDataSlicesSlice = SpeakersFeaturedSlice
...
export type SpeakerDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithUID<Simplify<SpeakerDocumentData>, 'speaker', Lang>

export type AllDocumentTypes = PageDocument | SpeakerDocument
